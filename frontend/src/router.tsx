...
// ── Client pages ────────────────────────────────────────────────────────────
const ClientClaims = React.lazy(() => import("./pages/client/Claims"));
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute role="client" />}>
          <Route element={<ClientLayout />}>
            ...
            {/* Preserve the branch's claims list and link each record to its live timeline. */}
            <Route path="/claims" element={<Titled title="Claims"><ClientClaims /></Titled>} />
