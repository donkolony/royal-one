 ...
 * Renders a panel after the workspace, clear of form controls to quickly "sign in" as a client or an adviser.
...
export default function DevLoginBanner() {
  ...
  return (
    <div className="relative my-4 ml-auto mr-4 bg-charcoal-800 text-white rounded-xl shadow-2xl border border-brand-500/40 p-4 w-72 max-w-[calc(100vw-2rem)] text-sm font-sans">
