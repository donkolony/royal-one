...
from app.api.v1 import advisor_routes, audit_routes, claims_routes, compliance_routes, core_routes, identity_routes, owner_routes, radar_routes, workflow_routes
...
def create_app(
    ...
    *,
    ...
    for router in (core_routes.router, claims_routes.router, advisor_routes.router, audit_routes.router, radar_routes.router, owner_routes.router, workflow_routes.router, identity_routes.router, compliance_routes.router):
